      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="prose prose-lg dark:prose-invert space-y-8 text-muted-foreground">
          ...
          <p>
            ...
            relates to the website <strong>___________</strong> (hereafter
            referred to as the “website” or the “site”), the services provided
            by <strong>KONKORD HOLDING OÜ</strong> (hereinafter referred to as
            the "Company", the owner and operator of the Site), and any related
            software applications (‘Apps’) where personal data relating to You
            is processed by the same (via the Site, any of Our Apps or
            otherwise).
          </p>
          <p>
            <strong>KONKORD HOLDING OÜ</strong> is a company that buys and sells
          ...
          <ul>
            ...
            <li>Inform you of your data protection rights.</li>
          </ul>

          <h2>2. The legal basis by which We process your personal data</h2>
          <p>
          ...
          <p>
            ...
            which applies in Estonia as an EU Member State, together with the
            Estonian Personal Data Protection Act (Isikuandmete kaitse seadus —
            PDPA) that implements and complements GDPR at the national level.
          </p>
          <p>
          ...
          <ul>
            <li>
              <strong>a) Contact Data</strong> includes billing address, mailing
              address, email address and contact numbers.
            </li>
            <li>
              <strong>b) Technical Data</strong> includes internet protocol (IP)
              address, your login data, browser type and version, time zone
              setting and location, browser plug-in types and versions,
              operating system and platform, as well as other information
              regarding your experience on Our Website such as page response
          ...
          <ul>
            <li>
              <strong>c) Marketing and Communications Data</strong> includes
              your preferences in receiving marketing from Us and Our third
              parties or associated entities and your communication preferences.
              This may include information on whether you have subscribed or
              unsubscribed from any of Our mailing lists, attended any of Our
              events or accepted any of Our invitations.
            </li>
          </ul>
          <p>
          ...
          <ul>
            <li>Filling in an enquiry form on the Website,</li>
            <li>
            ...
            <li>Requesting marketing to be sent to you,</li>
            <li>Giving Us some feedback,</li>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              third party), and where your interests and fundamental rights do
            ...
            <li>To manage the supplier relationship you have with us,</li>
            <li>
          ...
          <h2>9. Transfers of data to third countries</h2>
          <p>
            Where We share your personal data with internal or external third
            parties, this may involve transferring your data outside the
            Republic of Estonia. We will transfer your personal data in
            accordance with standard contractual clauses to ensure that your
            personal data is protected and transferred securely in compliance
            with applicable laws.
          </p>

          <h2>10. Third-party access to your personal data</h2>
          <p>
          ...
          <ol>
            <li>
              <strong>The right to correction.</strong> You have the right to
              obtain correction of any inaccurate personal data about you that
              We have processed, update any data that is out-of-date, and
              complete any incomplete personal data, including by means of a
              supplementary statement.
            </li>
            <li>
              <strong>The right to erasure.</strong> You have the right to
              obtain the erasure of personal data We have concerning you when it
              is no longer required, for cases where:
              <ul>
                <li>
                  You withdraw your consent to Us processing your personal data
                  on which the processing is originally based or where no other
                  legal grounds for processing exists,
                </li>
                <li>
                ...
                <li>
                  ...
                  legitimate grounds for the processing for marketing
                  communication,
                </li>
            ...
            <li>
              <strong>The right to data portability.</strong> We will provide to
              you, or a third party you have chosen, your personal data in a
              structured, commonly used, machine-readable format.
            </li>
            <li>
              <strong>Right to withdraw consent.</strong> Where you may have
              provided your consent to the collection, processing, and transfer
              of your personal information for a specific purpose (for example,
              for marketing), you have the right to withdraw your consent for
              that specific processing at any time, or you may withdraw your
              consent to this Privacy Policy. Once We have received notification
              that you have withdrawn your consent, we will no longer process
              your information for that purpose unless We have another
              legitimate basis for doing so in law. Withdrawal of consent to
              this Privacy Policy will result in Us having to terminate Our
              services with you immediately.
            </li>
          </ol>

          <h2>15. Law applicable to disputes</h2>
          <p>
            The Privacy Policy and its subject matter are governed by the laws
            of the Republic of Estonia. You hereby agree that the courts of
            Turkey shall have exclusive jurisdiction in relation to any claim,
            dispute or difference concerning the Engagement Letter and any
            matter arising from it. Each party irrevocably waives any right it
            may have to object to an action being brought in those courts, to
            claim that the action has been brought in an inconvenient forum, or
